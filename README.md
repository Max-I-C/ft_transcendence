...
5. 5 Implement Two-Factor Authentication (2FA) and JWT. 🔴
...
6. 6 Replace basic Pong with server-side Pong and implement an API. 🔴 
...
7. 7 Expanding Browser Compatibility. 🟢 (need additional test after creating the game)
